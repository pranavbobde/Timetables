...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { email: @faculty.email, name: @faculty.name, phonenumber: @faculty.phonenumber, room_id: @faculty.room_id, school: @faculty.school, type: @faculty.type } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { email: @faculty.email, name: @faculty.name, phonenumber: @faculty.phonenumber, room_id: @faculty.room_id, school: @faculty.school, type: @faculty.type } }
