...
class TimeSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post time_slots_url, params: { time_slot: { Date: @time_slot.Date, EndTime: @time_slot.EndTime, StartTime: @time_slot.StartTime } }
    end
  ...
  test "should update time_slot" do
    patch time_slot_url(@time_slot), params: { time_slot: { Date: @time_slot.Date, EndTime: @time_slot.EndTime, StartTime: @time_slot.StartTime } }
