...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post timeslots_url, params: { timeslot: { end: @timeslot.end, start: @timeslot.start } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { end: @timeslot.end, start: @timeslot.start } }
